...
<head>
    ...
    <title>Verifikasi OTP Registrasi - SPMB SMK Bakti Nusantara 666</title>
...
<body>
    <div class="otp-container">
        <div class="otp-header">
            ...
            <h3 class="mb-0">Verifikasi Registrasi</h3>
            <p class="mb-0">Masukkan kode OTP untuk menyelesaikan pendaftaran</p>
        </div>
        
        <div class="otp-body">
            <div class="info-box">
                <i class="fas fa-envelope text-primary me-2"></i>
                <small>Kode OTP telah dikirim ke <strong>{{ session('email') ?? (session('temp_user')['email'] ?? 'email Anda') }}</strong></small>
            </div>
            ...
            <form method="POST" action="{{ route('otp.verify') }}" id="otpForm">
                ...
                <button type="submit" class="btn btn-primary w-100 mb-3" id="submitBtn">
                    <i class="fas fa-check me-2"></i>Verifikasi & Daftar
                </button>
            </form>
            ...
            <div class="text-center">
                <small class="text-muted">
                    Tidak menerima kode? 
                    <button type="button" class="btn btn-link p-0 text-decoration-none" id="resendBtn">Kirim ulang</button>
                </small>
            </div>
        </div>
    </div>
